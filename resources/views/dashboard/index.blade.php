        ...
        <div class="mb-8">
            <div class="text-center space-y-4">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    ...
                    <a href="{{ route('sales.period') }}"
                       class="inline-flex items-center px-8 py-4 bg-indigo-500 hover:bg-indigo-600 text-white text-xl font-bold rounded-lg shadow-lg quick-action-btn transition-all duration-300">
                        <svg class="w-8 h-8 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                        </svg>
                        <span data-en="Period Report" data-id="Laporan Periode">Period Report</span>
                    </a>
                    @endif
    ...
    <div id="mobile-menu-drawer" class="mobile-drawer lg:hidden bg-white flex flex-col justify-between">
        <div class="p-4 flex-1 overflow-y-auto">
            ...
            <div class="space-y-2">
                ...
                <a href="{{ route('sales.period') }}" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-100 transition-colors group">
                    <svg class="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                    </svg>
                ...
                <a href="#" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-100 transition-colors group">
                    ...
                    <span class="text-gray-700 font-medium" data-en="Finance" data-id="Keuangan">Finance</span>
                </a>
                @endif
                
                @if(auth()->user()->edit_produk)
                <a href="#" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-100 transition-colors group">
                    <svg class="w-6 h-6 text-pink-500 group-hover:text-pink-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                    </svg>
                    <span class="text-gray-700 font-medium" data-en="Products" data-id="Produk">Products</span>
                </a>
                @endif

                @if(auth()->user()->edit_stok)
                <a href="#" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-100 transition-colors group">
                    <svg class="w-6 h-6 text-orange-500 group-hover:text-orange-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                    </svg>
                    <span class="text-gray-700 font-medium" data-en="Stock" data-id="Stok">Stock</span>
                </a>
                @endif

                @if(auth()->user()->edit_akun)
                <a href="#" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-100 transition-colors group">
                    <svg class="w-6 h-6 text-indigo-500 group-hover:text-indigo-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                    </svg>
                    <span class="text-gray-700 font-medium" data-en="Accounts" data-id="Akun">Accounts</span>
                </a>
                @endif
