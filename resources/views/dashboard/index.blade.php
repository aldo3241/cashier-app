            ...
            <div class="text-center space-y-4">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <a href="{{ route('sales.my-sales') }}" target="_blank"
                       class="inline-flex items-center px-8 py-4 bg-green-600 hover:bg-green-700 text-white text-xl font-bold rounded-lg shadow-lg quick-action-btn transition-all duration-300">
                    ...
                    <a href="{{ route('sales.all-sales') }}" target="_blank"
                       class="inline-flex items-center px-8 py-4 bg-purple-600 hover:bg-purple-700 text-white text-xl font-bold rounded-lg shadow-lg quick-action-btn transition-all duration-300">
                        <svg class="w-8 h-8 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-lg shadow stat-card p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">{{ $dashboardData['my_sales_today']['formatted_amount'] }}</p>
            ...
            <div class="bg-white rounded-lg shadow stat-card p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">{{ $dashboardData['all_sales_today']['formatted_amount'] }}</p>
            ...
            <div class="bg-white rounded-lg shadow stat-card p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-red-600">{{ $dashboardData['low_stock_count'] }}</p>
