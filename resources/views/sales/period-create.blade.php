...
<head>
    ...
    <title>Tambah Laporan Kasir - Spiritosanto</title>
...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800" data-en="Create Period Report" data-id="Tambah Laporan Kasir">Tambah Laporan Kasir</h1>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-lg shadow-sm p-8">
            <form action="{{ route('sales.period-store') }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" id="mulai" name="mulai" class="w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-200 pl-3 pr-10 py-2" value="{{ old('mulai', $mulai->format('Y-m-d H:i:s')) }}" required>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" id="akhir" name="akhir" class="w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-200 pl-3 pr-10 py-2" value="{{ old('akhir', $akhir->format('Y-m-d H:i:s')) }}" required>
                             <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                </svg>
                ...
                <div class="mb-8">
                    ...
                    <textarea id="catatan" name="catatan" rows="4" class="w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-200 p-2" placeholder="Enter Catatan">{{ old('catatan') }}</textarea>
                </div>
                ...
                <div class="flex justify-center">
                    <button type="submit" class="inline-flex items-center px-6 py-2 bg-purple-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-purple-700 active:bg-purple-900 focus:outline-none focus:border-purple-900 focus:ring ring-purple-300 disabled:opacity-25 transition ease-in-out duration-150">
                        <span data-en="Submit" data-id="Simpan">Submit</span>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function toggleLanguageHandler(e) {
                if(e) e.preventDefault(); // Prevent accidental form submission if button type is not specified
